...
static int import_mpi4py__MPI(void) {
  ...
  if (__Pyx_ImportFunction(module, "PyMPIPrequest_New", (void (**)(void))&__pyx_api_f_6mpi4py_3MPI_PyMPIPrequest_New, "PyObject *(MPI_Request)") < 0) goto bad;
  if (__Pyx_ImportFunction(module, "PyMPIGrequest_New", (void (**)(void))&__pyx_api_f_6mpi4py_3MPI_PyMPIGrequest_New, "PyObject *(MPI_Request)") < 0) goto bad;
  ...
  if (__Pyx_ImportFunction(module, "PyMPISession_New", (void (**)(void))&__pyx_api_f_6mpi4py_3MPI_PyMPISession_New, "PyObject *(MPI_Session)") < 0) goto bad;
  if (__Pyx_ImportFunction(module, "PyMPISession_Get", (void (**)(void))&__pyx_api_f_6mpi4py_3MPI_PyMPISession_Get, "MPI_Session *(PyObject *)") < 0) goto bad;
  ...
  __pyx_ptype_6mpi4py_3MPI_Session = __Pyx_ImportType(module, "mpi4py.MPI", "Session", sizeof(struct PyMPISessionObject), __Pyx_ImportType_CheckSize_Warn);
   if (!__pyx_ptype_6mpi4py_3MPI_Session) goto bad;
